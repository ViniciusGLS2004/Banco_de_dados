...
select ven_nome, ven_data, ven_quantidade, ven_fk_cliente, ven_fk_prod
from itens_vendidos;
select * from vw_vendidos;

select sum(ven_quantidade) as total_produtos_vendidos -- a soma das quantidades vendidas de acordo com o mes
from itens_vendidos -- tabela que tem esses dados
where year(ven_data) = 2023 and month(ven_data) = 9; -- extrai o ano da venda extrai o mês venda
...
select iten_nome, iten_data, iten_quantidade, iten_fk_ser, iten_fk_prod, iten_fk_cliente
...
select sum(iten_quantidade) as total_servico_vendidos -- a soma das quantidades vendidas de acordo com o mes
from inten_odm_servico -- tabela que tem esses dados
where year(iten_data) = 2023 and month(iten_data) = 9; -- extrai o ano da venda, extrai o mês da venda
